...
mysql -h ${myhost} -P ${myport} -u ${myuser} ${mydb} -e "ALTER TABLE login_log ADD INDEX ip (ip)"
mysql -h ${myhost} -P ${myport} -u ${myuser} ${mydb} -e "ALTER TABLE login_log ADD INDEX user_id (user_id)"
